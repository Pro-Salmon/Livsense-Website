      ...
      <main className="px-4 py-6 space-y-6 max-w-md mx-auto">
          ...
          <motion.div
            ...
            className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
              ...
              <div className="bg-white rounded-2xl p-8 w-full max-w-sm text-center shadow-2xl">
                <div className="mx-auto w-20 h-20 bg-[#52796f]/20 rounded-full flex items-center justify-center mb-6">
                  <CheckCircle2 className="w-10 h-10 text-[#52796f]" />
                </div>
        ...
        <motion.button
          ...
          className={`
            ...
            ${selectedSymptoms.length > 0 ? 'bg-[#52796f] text-white shadow-[#52796f]/30 hover:bg-[#466a60]' : 'bg-gray-200 text-gray-400 cursor-not-allowed shadow-none'}
          `}>
